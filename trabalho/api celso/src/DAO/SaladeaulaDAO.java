...
public class SaladeaulaDAO {
    ...
    private Classroom mapResultSetToClassroom(ResultSet resultSet) throws SQLException {
        ...
        Teacher teacher = new ProfessorDAO().getTeacherById(ConnectionDB.getConnection(), teacherId);
        Discipline discipline = new DisciplinaDAO().getDisciplineById(ConnectionDB.getConnection(), disciplineId);
